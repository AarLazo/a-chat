...
import com.a_chat.a_chat.users.model.*;
...
import com.a_chat.a_chat.users.services.*;
...
public class UserController {
    ...
    private final GetUserDTOService getUserDTOService;
    ...
    public UserController(
            ...
            GetUserDTOService getUserDTOService,
        ...
        this.getUserDTOService = getUserDTOService;
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable Integer userID){
        return getUserDTOService.execute(userID);
    }
